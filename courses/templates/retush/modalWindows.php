<div class="modalWindow tariffKuratorModal fix-block modalWindow--withoutPadding">
    <div class="modalWindow-wrapper callbackModal__wrapper">
        ...
        <div class="modalWindow-form callbackModal__form">
            <script id="58ab262eac29abb17d27862213a46bfc39cfb402" src="https://lk.senseischool.ru/pl/lite/widget/script?id=730364"></script>
        </div>
    </div>
</div>
<div class="modalWindow tariffAuthorModal fix-block modalWindow--withoutPadding">
    <div class="modalWindow-wrapper callbackModal__wrapper">
        <button class="modalWindow-close">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M12.8869 11.9254L20.7174 4.64784L19.2776 3.09863L11.4471 10.3762L12.1675 11.1513L12.8869 11.9254Z" fill="#171717" />
        ...
        <div class="modalWindow-form callbackModal__form">
            <script id="6b6139cf32328e9af0dc6ad7b147a5edd32d3221" src="https://lk.senseischool.ru/pl/lite/widget/script?id=800021"></script>
        </div>
    </div>
</div>