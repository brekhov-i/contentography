            ...
            <ul class="courseThemes__list">
                <div class="list__line">
                    <svg width="2" height="477" viewBox="0 0 2 477" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1 0L0.999979 477" stroke="#E0DED2" stroke-width="2" stroke-dasharray="4 4" />
                    </svg>
                ...
                <li class="list__item">
                    ...
                    <div class="item__content">
                        ...
                        <ul class="item__list">
                            ...
                            <li>Какие качества важны, когда намерен стать известным</li>
                ...
                <li class="list__item">
                    ...
                    <div class="item__content">
                        ...
                        <ul class="item__list">
                            ...
                            <li>Что делать, если у тебя нет доступа к стилистам</li>
                            <li>Нетворкинг и работа с командой</li>
                ...
                <li class="list__item">
                    ...
                    <div class="item__content">
                        ...
                        <ul class="item__list">
                            ...
                            <li>Пример пути Макса и его учеников</li>
                            <li>Что ждёт тебя в мире фэшн</li>
                            <li>Как зарабатывать обычному фотографу больше в любом городе</li>
                            <li>Анонс и скидка на новую версию курса "Как сделать имя в мире фотографии"</li>
                        </ul>
                    </div>
                </li>
            </ul>
