...
<section class="sectionWithPosts">
    <div class="container">
        <div class="sectionWithPosts__wrapper">
            <h2 class="section-title sectionWithPosts__title">Статьи о фотографии</h2>
            <p class="sectionWithPosts__desc">Мы стараемся собирать самые интересные материалы, чтобы вы могли изучать индустрию с разных сторон.</p>
            <?php if (!empty($posts) && is_array($posts)) : ?>
                <div class="sectionWithPosts__linkWrapper">
                    <a href="<?php echo get_post_type_archive_link("post"); ?>" class="sectionWithPosts__link">
                        Все статьи
                ...
                <div class="sectionWithPosts__carts">
